...
CREATE PROCEDURE `User_add`(
    IN ifullname VARCHAR(64) NOT NULL,
    IN iusername VARCHAR(32) NOT NULL,
    IN iemail VARCHAR(64) UNIQUE NOT NULL,
    IN ipassword VARCHAR(64) NOT NULL,
    IN iphone VARCHAR(16) DEFAULT NULL,
...
CREATE PROCEDURE `Order_add`(
    IN iuser_id INTEGER,
    IN iinvoice_number INTEGER UNSIGNED NOT NULL,
    IN imethod ENUM("tunai", "transfer") NOT NULL,
    IN itotal_items INTEGER UNSIGNED NOT NULL,
    IN itotal_price INTEGER UNSIGNED NOT NULL,
